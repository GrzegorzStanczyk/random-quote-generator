(function() {
  ...
  const quotes = "https://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=1&_jsonp=JSONPCallback";
  ...
  const loadTwitter = (citeContent, citeAuthor) => {
